...
**Owner**:
The authenticated person who creates and publishes a site, directly from the dashboard or through an agent acting on their behalf. Only the owner can manage the site and view it while it is private.
